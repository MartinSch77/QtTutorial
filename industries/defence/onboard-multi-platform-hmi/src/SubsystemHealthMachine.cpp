    ...
    , m_monitor(nominalLow, nominalHigh, criticalLow, criticalHigh)
{
    ...
    m_nominalState.addTransition(&m_monitor, &SubsystemHealthMonitor::cautionDetected, &m_cautionState);
    m_nominalState.addTransition(&m_monitor, &SubsystemHealthMonitor::criticalDetected, &m_criticalState);
    m_cautionState.addTransition(&m_monitor, &SubsystemHealthMonitor::nominalDetected, &m_nominalState);
    m_cautionState.addTransition(&m_monitor, &SubsystemHealthMonitor::criticalDetected, &m_criticalState);
    m_criticalState.addTransition(&m_monitor, &SubsystemHealthMonitor::nominalDetected, &m_nominalState);
    m_criticalState.addTransition(&m_monitor, &SubsystemHealthMonitor::cautionDetected, &m_cautionState);
