...
// plain geometric paths on a Canvas - no icon font or external asset. See
// the matching icon in onboard-wall-panel/src/qml/LightbulbIcon.qml; each
// app keeps its own small set of QML icon components, the same way both
// apps already keep independent copies of ToggleSwitch.qml/SliderControl.qml.
Item {
    id: root
