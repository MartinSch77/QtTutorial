...
// A small thermostat-dial glyph (a compact cousin of ThermostatGauge.qml's
// full-size Canvas arc gauge) used where the full gauge would be too heavy,
// e.g. scene cards and mode buttons - plain geometric paths on a Canvas.
Item {
    id: root
