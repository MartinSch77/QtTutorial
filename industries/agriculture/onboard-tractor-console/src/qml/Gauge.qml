...
// A hand-painted circular gauge (270 degree sweep), used for both the fuel level
// and engine load readouts. No image assets: the arc, ticks and needle are all
// drawn on a Canvas so the console stays fully vector and themeable.
Item {
    id: root
