...
ProductionTrendWidget::ProductionTrendWidget(QWidget* parent)
    : QWidget(parent)
{
    setMinimumHeight(160);
}

void ProductionTrendWidget::setValues(const std::vector<double>& values, double maxValue)
{
    m_values = values;
...
void ProductionTrendWidget::paintEvent(QPaintEvent* /*event*/)
{
    ...
    if (m_values.size() < 2) {
        ...
        painter.drawText(rect(), Qt::AlignCenter, tr("Collecting production history..."));
        return;
    }
